...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const lessonOne = require("../../Homework_01/js/Script.js");
  ...
  document.querySelector(".btn_lesson_5").onclick = () => {
    resultBlock.classList.remove("container");
    resultBlock.innerHTML = `Заміна поганих слів: ${lessonFive(
      "This man a fucking  piece of shit",
      "fuck,shit"
    )}`;
  };
  ...
  document.querySelector(".btn_lesson_8").onclick = () => {
    resultBlock.classList.remove("container");
    let person = new lessonEight(
      "Київський НУХТ",
      3,
      "Шагієв Борис Анатолійович"
    );
